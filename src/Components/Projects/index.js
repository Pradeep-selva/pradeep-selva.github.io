...
import Connecsoc from '../../img/connecsoc.png'
import Arcadia from '../../img/arcadia.jpg'
            ...
            <section className="container section" id="projects">
                <div className="row">
                    ...
                    <div className="col s12 m4 l4">
                        <div className={cardStyle}>
                            <div className="card-image">
                                <img src={Connecsoc} alt="connecsoc" className="z-depth-3 responsive-img materialboxed" />
                                <span className="card-title" id="weather">Connecsoc</span>
                                <a href="https://github.com/Pradeep-selva/connecsoc"
                                    className="pulse btn-floating halfway-fab waves-effect waves-light blue-grey darken-1"><i
                                        className="material-icons">developer_mode</i></a>
                            </div>
                            <div className="card-content">
                    ...
                    <div className="col s12 m4 l4">
                        <div className={cardStyle}>
                            <div className="card-image">
                                <img src={Arcadia} alt="pong" className="z-depth-3 responsive-img materialboxed" />
                                <span className="card-title" id="weather">Arcadia discord bot</span>
                                <a href="https://github.com/Pradeep-selva/Arcadia-Bot"
                                    className="pulse btn-floating halfway-fab waves-effect waves-light blue-grey darken-1"><i
                                        className="material-icons">developer_mode</i></a>
                            </div>
                            <div className="card-content">
