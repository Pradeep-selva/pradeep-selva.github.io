          ...
          <div class='card z-depth-4'>
            <div class='card-content purple lighten-4'>
              {curTitle === "GitHub" ? (
                ...
                <Icon icon={codeforcesIcon} className='iconify' />
              )}
              <h4>{curTitle}</h4>
            </div>
            <div class='card-tabs'>
              <ul class='tabs '>
                <li class='tab'>
                  <a href='#codeforces' onClick={clickCf}>
                    Codeforces
                  </a>
                </li>
                <li class='tab'>
                  <a href='#github' onClick={clickGh}>
                    GitHub
                  </a>
                </li>
              </ul>
            ...
            <div class='card-content purple lighten-5'>
              ...
              <div id='github'>
                ...
                >
                  ...
                  <li>
                    <span className='title'>Public Repos: </span>
                    {gh.public_repos}
                  </li>
                  <li>
                ...
                <div className='link'>
                  <a
                    href={gh.html_url}
                    className='purple-text text-darken-2 link'
                  >
                    View Profile
                  </a>
                </div>
